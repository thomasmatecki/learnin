...
int lcs(char[], char[]);
TEST(LongestCommonSubsequenceTestSuite, LCSBaseCases) {
  char in0[] = "ABC";
  char in1[] = "ABC";
...
TEST(LongestCommonSubsequenceTestSuite, LCSDifferingLengthCases) {
  char in0[] = "AABC";
  char in1[] = "ABC";
  EXPECT_EQ(lcs(in0, in1), 3) << "The value is not correct";
  ...
  char in6[] = "ADBC";
  char in7[] = "ABC";
  EXPECT_EQ(lcs(in6, in7), 3) << "The value is not correct";
}