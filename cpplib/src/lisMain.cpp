...
TEST(LongestIncreasingSubStringTestSuite, LISBaseCases)
{
    const int LENGTH = 1;
    int in[LENGTH] = {1};
...
TEST(LongestIncreasingSubStringTestSuite, LISSimpleIncreasing)
{
